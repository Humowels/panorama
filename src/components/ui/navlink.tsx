...
export const NavLink = React.forwardRef<HTMLAnchorElement, IProps>(
  ({ className, ...props }, ref) => {
    ...
    const activeClass =
      "bg-secondary relative after:content-['']  after:absolute after:-bottom-[11px] after:-left-[1px] after:w-0 after:h-0  after:border-l-[50px] after:border-r-[50px] after:border-t-[10px] after:border-t-secondary after:border-l-white after:border-r-white ";
